...
const SCENES = {
  today: {
    ...
    heroImage: '/assets/brand/gudian-mascot.png',
  ...
  tutor: {
    ...
    heroImage: '/assets/brand/gudian-mascot-study.png',
    primaryLabel: '进入追问对话',
  ...
  review: {
    ...
    heroImage: '/assets/brand/review-sprout.png',
  ...
  parent: {
    ...
    heroImage: '/assets/brand/family-report.png',
    primaryLabel: '查看详细报告',
...
Page({
  ...
  onLoad(query = {}) {
    ...
    this.setData({ scene: SCENES[key] || SCENES.today });
  },
