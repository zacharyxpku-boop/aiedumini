...
function buildPrivateTutorModeRouter(input = {}, miniLesson = {}) {
  ...
  const routeByMode = {
    ...
    practice_recall: '/pages/review/review?from=mini_lesson_exit_passed',
  ...
  return {
    ...
    allowedNextModes: ['socratic_private_tutor', 'three_minute_mini_lesson', 'practice_recall', 'parent_handoff'],
...
function buildThreeMinuteMiniLesson(input = {}) {
  ...
  const renderGate = {
    ...
    blockedWhen: ['parent_handoff', 'socratic_private_tutor', 'practice_recall'],
