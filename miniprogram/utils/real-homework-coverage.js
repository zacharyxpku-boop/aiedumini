const SUBJECT_COUNTS = [
  ...
  { id: 'physics', label: '物理', count: 17, nextGap: '受力、光路、电路、浮力、压强、电路故障、杠杆、电功率和图像题继续补真实卡点。' },
  { id: 'chemistry', label: '化学', count: 18, nextGap: '实验现象、气体验证、溶液、守恒、酸碱图像、过滤、反应速率、溶解度曲线、离子检验继续拆错因。' },
  { id: 'english', label: '英语', count: 19, nextGap: '语法信号、比较级、被动语态、定语从句、完形上下文、阅读推断和标题题继续扩样。' },
...
const TYPE_COUNTS = [
  ...
  { id: 'physics_diagram', label: '物理图解', count: 17, firstStep: '先定对象、方向、单位、路径、力臂、受力面积、电表位置或决定量。' },
  { id: 'chemistry_experiment', label: '化学实验/变化', count: 18, firstStep: '先列反应物、现象、体系边界、守恒关系、唯一变量、过滤条件、曲线定位和检验试剂。' },
  { id: 'english_sentence', label: '英语句法/上下文', count: 13, firstStep: '先找时态、主语、比较、被动、先行词或上下文信号。' },
  { id: 'reading_question', label: '阅读证据', count: 20, firstStep: '先判断题目类型，再回文定位证据、意象、说明顺序、标题中心或推断行为。' },
