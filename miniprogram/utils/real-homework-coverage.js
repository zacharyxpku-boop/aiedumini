const SUBJECT_COUNTS = [
  { id: 'math', label: '数学', count: 67, nextGap: '比例、百分数、几何角、函数图像、二次函数顶点、全等证明、相似面积比、单位量比较、统计抽样、概率、不放回样本空间、移项符号、浓度/分段收费/年龄/行程/利润/几何方程继续补跨学科词面误判样本。' },
  { id: 'physics', label: '物理', count: 52, nextGap: '受力、光路、电路、串并联电流、浮力密度、压强面积、电路故障、欧姆定律变量控制、杠杆力臂、电功率、热效率、热传递、状态变化和图像题继续补真实卡点。' },
  { id: 'chemistry', label: '化学', count: 54, nextGap: '实验现象、气体验证、溶液质量分数、金属活动性、守恒、微粒观、酸碱指示剂、pH 加液方向、变量控制、开放体系、粗盐提纯、反应速率、溶解度曲线、过滤操作、离子共存和气体检验继续拆错因。' },
  { id: 'english', label: '英语', count: 55, nextGap: '语法信号、现在完成时、比较级、被动语态、介词范围、定语从句、非谓语目的、状语从句 unless、代词指代、完形上下文、阅读推断、标题题和逻辑连词继续扩样。' },
  { id: 'biology', label: '生物', count: 52, nextGap: '显微镜高低倍、遗传显隐性、生态系统成分、呼吸作用、光合呼吸区分、人体循环、血糖调节、反射弧、蒸腾作用、生态角色和能量流动继续验证小黑板边界。' },
  { id: 'geography', label: '地理', count: 54, nextGap: '经纬网、等高线河流流向、气候图、气候类型、交通/农业/工业区位、地球自转时差、纬度气温、季风成因、板块边界、人口迁移继续验证空间和区位误判。' },
  { id: 'chinese', label: '语文', count: 64, nextGap: '阅读概括、记叙文标题线索、议论文论据作用、古诗意象、修辞赏析、说明方法、说明语言、说明顺序、文言虚词、句式转换、写作起步、段落中心、选材、语段衔接、结尾照应、细节描写、病句修改继续压测。' }
];

const TYPE_COUNTS = [
  { id: 'math_word_problem', label: '数学应用/建模', count: 51, firstStep: '先翻译数量关系、图形关系、变化基准、统计总量、抽样代表性、概率分母、不放回样本空间、比例份数、单位量、函数坐标、二次函数顶点、全等对应条件或相似维度。' },
  { id: 'equation_setup', label: '方程/不等式建模', count: 16, firstStep: '先设未知数、写等量或不等量关系，或拆浓度、分段收费、不等式变形规则、移项符号、同步时间点。' },
  { id: 'physics_diagram', label: '物理图解', count: 52, firstStep: '先定对象、方向、单位、路径、串并联分支、力臂、受力面积、电表位置、故障位置、控制变量、热量方向、热效率输入输出、浮力决定量、状态变化或决定量。' },
  { id: 'chemistry_experiment', label: '化学实验/变化', count: 54, firstStep: '先列反应物、现象、体系边界、微粒解释、守恒关系、唯一变量、酸碱性质、金属活动性、溶液总质量、pH 起点方向、过滤/提纯条件、溶解度曲线定位、离子共存排查和气体检验试剂。' },
  { id: 'english_sentence', label: '英语句法/上下文', count: 43, firstStep: '先找时态、持续时间信号、主语、比较、被动、介词范围、先行词、从句成分、目的关系、unless 逻辑、代词指代或上下文信号。' },
  { id: 'reading_question', label: '阅读证据', count: 54, firstStep: '先判断题目类型，再回文定位证据、标题线索、议论文观点、意象、修辞本体喻体、说明方法、说明语言、文言功能、说明顺序、标题中心或推断行为。' },
  { id: 'biology_process', label: '生物过程', count: 52, firstStep: '先分结构、功能、方向、变量、能量流动、生态角色、调节路径、显微镜操作、显隐性基因、光合呼吸条件、蒸腾路径、生态成分、过程条件或循环路径。' },
  { id: 'geography_map', label: '地理图示', count: 54, firstStep: '先看图例、方向、经纬、纬度热量、地球自转方向、海拔、等高线形态、太阳高度、气候证据、农业/工业区位条件、水汽来源、板块边界、人口迁移推拉力或成因链。' },
