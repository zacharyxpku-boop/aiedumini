const SUBJECT_COUNTS = [
  { id: 'math', label: '数学', count: 29, nextGap: '比例、百分数、几何角、函数图像、统计平均数、概率、浓度/分段收费/年龄/行程/利润/几何方程继续补变式压力样本。' },
  { id: 'physics', label: '物理', count: 18, nextGap: '受力、光路、电路、浮力、压强、电路故障、杠杆、电功率、热传递和图像题继续补真实卡点。' },
  { id: 'chemistry', label: '化学', count: 19, nextGap: '实验现象、气体验证、溶液、守恒、微粒观、酸碱图像、过滤、反应速率、溶解度曲线、离子检验继续拆错因。' },
  { id: 'english', label: '英语', count: 21, nextGap: '语法信号、比较级、被动语态、定语从句、非谓语、状语从句、完形上下文、阅读推断和标题题继续扩样。' },
  { id: 'biology', label: '生物', count: 17, nextGap: '显微镜、遗传、生态系统成分、呼吸作用、人体循环继续验证小黑板边界。' },
  { id: 'geography', label: '地理', count: 19, nextGap: '经纬网、等高线、气候图、气候类型、工业区位、地球运动、季风成因继续验证空间误判。' },
  { id: 'chinese', label: '语文', count: 27, nextGap: '阅读概括、古诗意象、说明方法、说明顺序、文言词语、句式转换、写作起步、段落中心、选材、结尾照应、细节描写和单句修改继续压测。' }
];
...
const TYPE_COUNTS = [
  ...
  { id: 'physics_diagram', label: '物理图解', count: 18, firstStep: '先定对象、方向、单位、路径、力臂、受力面积、电表位置、热量方向或决定量。' },
  { id: 'chemistry_experiment', label: '化学实验/变化', count: 19, firstStep: '先列反应物、现象、体系边界、微粒解释、守恒关系、唯一变量、过滤条件、曲线定位和检验试剂。' },
  { id: 'english_sentence', label: '英语句法/上下文', count: 15, firstStep: '先找时态、主语、比较、被动、先行词、目的关系、逻辑连词或上下文信号。' },
  { id: 'reading_question', label: '阅读证据', count: 22, firstStep: '先判断题目类型，再回文定位证据、意象、说明方法、说明顺序、标题中心或推断行为。' },
  { id: 'biology_process', label: '生物过程', count: 17, firstStep: '先分结构、功能、方向、变量、能量流动、生态角色、过程条件或循环路径。' },
  { id: 'geography_map', label: '地理图示', count: 19, firstStep: '先看图例、方向、经纬、海拔、气候证据、区位条件、水汽来源或成因链。' },
