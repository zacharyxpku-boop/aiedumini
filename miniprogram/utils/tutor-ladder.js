const ANSWER_REQUEST_RE = /直接告诉我答案|求答案|不想写过程|不用讲第一步|直接给最终数字|最终数字|最终答案|马上填空|拍照出答案|直接给结果|告诉我答案|给答案|答案是什么|直接说结果|帮我写答案|直接帮孩子写|帮孩子写.*字|成文|代写|替他.*写|直接替|完整解题板书|完整动态板书|完整错题答案|从第一步到最后答案|照着写|完整板书.*结论|最后结论|直接给拍题|假装已经识别|已经看过孩子的照片|带孩子分数|排名.*转发|tell me the answer|沿用昨天的答案|不用重新看|直接套|没有给横轴纵轴|不用读图|直接判断|别问排开体积|直接套公式|超过同龄人|错题原文|老师点评|动态电路动画|完整解题过程|已生成动态|掌握全章|完全掌握|进入下一单元|标准答案|直接搬到报告|不要再问孩子|推到最后答案|不用说自己的第一步|班级排行榜|原题截图|完整几何板书|直接发 XP|解锁下一单元|不用本地规则|超过班里大多数人|制造转介绍|沿用第一次概率|不用更新总数|完整证明步骤|最终结论|已掌握七科核心题型|解锁全部游戏奖励/i;
...
function detectTaskType(text = '', selected = {}) {
  ...
  const pressureSignal = inferHomeworkPressureSignal(source, 'unknown');
  if (pressureSignal && pressureSignal.taskType && pressureSignal.taskType !== 'unknown') {
    return pressureSignal.taskType;
  }
...
function inferHomeworkPressureSignal(text = '', taskType = 'unknown') {
  ...
  const pressureHomeworkCases = [
    ['pressure_relative_pronoun_book_type', /the book，选 which、who 还是 that/, 'english_sentence', '先找先行词是人还是物，再选关系词。', '只看空格后面缺词，没有先判断先行词类型。', '小黑板只写“先行词：人/物 -> 关系词”。', '先问：被修饰的词是人还是物？从句里缺主语还是宾语？', '换一个先行词，仍先判断人或物。'],
    ['pressure_relative_pronoun_person_thing', /选择 who\/which\/that|which、who 还是 that|先行词是人还是物/, 'english_sentence', '先圈出先行词，再判断它是人还是物。', '不找先行词，只凭空格附近词猜关系代词。', '小黑板只画“先行词 -> 人/物 -> 关系代词”。', '先问：这个从句修饰前面的哪个词？', '换成 whose/where，仍先找先行词。'],
    ['pressure_mass_fraction_general', /一定质量溶质加入水中|没有加上溶质质量/, 'chemistry_experiment', '先写分母是溶液质量，也就是溶质质量加溶剂质量。', '把溶剂质量当成溶液质量，分母少算了溶质。', '小黑板只画“溶质 + 溶剂 = 溶液”。', '先问：质量分数的分母是水，还是整个溶液？', '换成加水稀释，仍先更新溶液总质量。'],
    ['pressure_metal_activity_color_existing', /表面出现红色物质.*只记颜色|表面出现红色物质.*只背现象/, 'chemistry_experiment', '先判断铁比铜活泼，可能把铜置换出来。', '只记实验颜色，没有连接金属活动性顺序。', '小黑板只画“活泼金属 -> 置换较不活泼金属”。', '先问：红色物质可能是谁？铁和铜谁更活泼？', '换成锌和硫酸铜，仍先比较活动性。'],
    ['pressure_solution_fraction_existing', /10 克盐加入 90 克水|把水的质量当分母/, 'chemistry_experiment', '先判断溶液质量等于溶质质量加溶剂质量。', '把溶剂质量当分母，没有先求溶液总质量。', '小黑板只画“溶质 + 溶剂 = 溶液”。', '先问：质量分数的分母是水，还是整个溶液？', '换成加水稀释，仍先更新溶液总质量。'],
    ['pressure_expository_order_existing', /桥的结构.*说明顺序|段落之间的先后关系/, 'reading_question', '先看每段介绍对象从整体到局部，还是从原因到结果。', '只抓一个细节，没有看段落推进顺序。', '小黑板只画“第1段 -> 第2段 -> 第3段”的说明对象变化。', '先问：每段说的对象是在变大、变小，还是按时间推进？', '换成介绍植物生长的说明文，仍先看段落顺序。'],
    ['pressure_circuit_fault_existing', /断路还是短路.*直接猜灯泡坏了/, 'physics_diagram', '先看电压表测哪两点，再判断这两点之间是否断路。', '凭现象猜，没有先定位电表连接位置。', '小黑板只画“电压表两端 -> 高电压 -> 可能断路点”。', '先问：电压表接在哪两个点？它读的是哪一段？', '换成电流表示数异常，仍先看仪表位置。'],
    ['pressure_relative_clause_existing', /只看空格.*先行词|先行词 book 和 bought 后缺宾语/, 'english_sentence', '先找先行词 book，再判断从句里 bought 后缺宾语。', '只看空格位置，没有检查先行词和从句缺什么成分。', '小黑板只写“先行词 -> 从句缺成分 -> 关系词”。', '先问：空格前面被修饰的词是谁？从句里缺主语还是宾语？', '换成修饰 person 的句子，仍先找先行词和从句成分。'],
    ['pressure_plate_boundary_existing', /环太平洋多地震火山|没有联系板块交界和挤压张裂/, 'geography_map', '先判断位置是否在板块交界处，再看是挤压还是张裂边界。', '把地震火山当成随机分布，没有联系板块边界。', '小黑板只画“板块边界 -> 挤压/张裂 -> 地震火山”。', '先问：这个区域在板块内部还是交界处？', '换成地中海喜马拉雅带，仍先找板块交界。'],
    ['pressure_quadratic_vertex_axis', /二次函数作业.*抛物线开口和对称轴|顶点和最值/, 'math_word_problem', '先找对称轴，再判断顶点横坐标和开口方向。', '把二次函数当一次函数代点，没有先看对称轴和开口。', '小黑板只画“对称轴 -> 顶点 -> 开口方向”。', '先问：这条抛物线的对称轴在哪里？开口向上还是向下？', '换成配方式二次函数，仍先找顶点和开口。'],
    ['pressure_congruence_condition_order', /证明两个三角形全等|两条边相等就直接写结论|夹角或对应关系/, 'math_word_problem', '先标出两个三角形的对应顶点，再判断能用 SSS、SAS 还是 ASA。', '只看到边相等，没有确认对应关系和全等条件。', '小黑板只画“对应点 -> 已知边角 -> 全等条件”。', '先问：这条边对应哪条边？夹角有没有被证明相等？', '换成 ASA 证明，仍先标对应点和已知条件。'],
    ['pressure_ohm_law_variable_control', /欧姆定律实验题|电流和电压关系.*同时换了电阻和电压/, 'physics_diagram', '先确认研究电流和电压关系时电阻必须保持不变。', '没有控制变量，同时改变电阻和电压导致结论不可靠。', '小黑板只画“研究变量：电压；保持不变：电阻”。', '先问：这次只想研究哪一个变量？哪个条件必须不变？', '换成研究电流和电阻关系，仍先列唯一变量和不变量。'],
    ['pressure_circuit_fault_voltmeter', /电压表示数接近电源电压|电压表接在哪两端/, 'physics_diagram', '先看电压表接在哪个元件两端，再判断该处可能断路。', '凭现象猜故障，没有用电表位置和示数定位断路。', '小黑板只画“电压表两端 -> 高电压 -> 可能断路点”。', '先问：电压表量的是哪两点之间？为什么那里会接近电源电压？', '换成电流表无示数，仍先看电表位置和电路是否断开。'],
    ['pressure_metal_activity_displacement', /铁片放入硫酸铜溶液|金属活动性作业|置换关系/, 'chemistry_experiment', '先比较铁和铜的金属活动性，判断铁能否把铜置换出来。', '只背溶液颜色，没有把金属活动性和置换反应对应。', '小黑板只画“Fe 比 Cu 活泼 -> Cu 被置换”。', '先问：谁更活泼？更活泼的金属能不能把不活泼的金属换出来？', '换成锌和硫酸亚铁，仍先比较金属活动性。'],
    ['pressure_mass_fraction_solution', /质量分数.*水的质量当分母|没有加上溶质质量/, 'chemistry_experiment', '先写分母是溶液质量，也就是溶质质量加溶剂质量。', '把溶剂质量当成溶液质量，分母少算了溶质。', '小黑板只画“溶质 + 溶剂 = 溶液”。', '先问：质量分数的分母是水，还是整个溶液？', '换成加水稀释，仍先更新溶液总质量。'],
    ['pressure_present_perfect_since', /since 2020|现在完成时和持续到现在/, 'english_sentence', '先圈 since 2020，判断动作或状态从过去持续到现在。', '只看过去时间点，没有判断是否延续到现在。', '小黑板只写“since + 过去时间 -> have/has done”。', '先问：这个动作只是过去发生，还是一直持续到现在？', '换成 for three years，仍先判断持续时间信号。'],
    ['pressure_relative_clause_component', /The book ____ I bought yesterday|从句缺宾语/, 'english_sentence', '先找先行词 book，再判断从句 bought 后缺宾语。', '只看先行词，没有检查从句缺什么成分。', '小黑板只写“先行词 -> 从句缺成分 -> 关系词”。', '先问：从句里 bought 后面少了什么？', '换成缺主语的定语从句，仍先看从句成分。'],
    ['pressure_expository_structure_order', /说明顺序|时间、空间或逻辑线索/, 'reading_question', '先圈表示时间、空间或因果递进的线索词。', '把段落内容当说明顺序，没有找结构线索。', '小黑板只写“时间词 / 方位词 / 因果词”。', '先问：文章是按时间走、按地点走，还是按原因结果走？', '换成另一篇说明文，仍先找线索词再判断顺序。'],
    ['pressure_rhetoric_effect', /用了比喻.*表达效果|本体、喻体和效果/, 'reading_question', '先找本体和喻体，再说它把什么特点写具体。', '只识别修辞名称，没有连接形象特点和表达效果。', '小黑板只画“本体 -> 喻体 -> 特点”。', '先问：它把什么比作什么？这个比喻让哪个特点更明显？', '换成拟人句，仍先说写出了什么特点。'],
    ['pressure_transpiration_path', /蒸腾作用作业|水分从根到叶再散失|连根、茎、叶/, 'biology_process', '先按根吸水、茎运输、叶片气孔散失排路径。', '只记住叶片散失，没有把结构和运输路径连起来。', '小黑板只画“根 -> 茎 -> 叶 -> 气孔”。', '先问：水先从哪里进入植物？最后从哪里散失？', '换成矿质元素运输，仍先按根茎叶路径说。'],
    ['pressure_ecosystem_role', /草、兔、细菌分别属于什么成分|所有生物都写成消费者/, 'biology_process', '先判断谁能制造有机物，谁取食，谁分解遗体残骸。', '只看到都是生物，没有按功能区分生产者、消费者和分解者。', '小黑板只画“制造 / 取食 / 分解”三栏。', '先问：它在生态系统里主要做制造、取食还是分解？', '换成蘑菇和鹰，仍先按功能分类。'],
    ['pressure_plate_boundary_quake', /地震火山多发原因|环太平洋.*板块交界/, 'geography_map', '先判断位置是否在板块交界，再看是挤压还是张裂。', '把地震火山当成地名记忆，没有连接板块边界运动。', '小黑板只画“板块交界 -> 挤压/张裂 -> 地震火山”。', '先问：这个地方在板块内部还是板块交界？', '换成地中海喜马拉雅带，仍先找板块交界。'],
    ['pressure_population_migration_push_pull', /人口从山区迁往城市|就业、交通、教育等拉力|人口迁移作业/, 'geography_map', '先分迁出地推力和迁入地拉力，再列一个最直接因素。', '只看城市规模，没有区分推力和拉力。', '小黑板只画“迁出地推力 / 迁入地拉力”两栏。', '先问：人为什么离开原地？又为什么去这个城市？', '换成沿海地区人口流入，仍先分推力和拉力。'],
    ['pressure_negative_number_equation_sign', /-3x 移到等号右边|移项时.*忘了变号|结果总差一截/, 'equation_setup', '先只圈移动到等号另一边的项，再写“过等号要变号”。', '把移项当成搬位置，没有处理符号变化。', '小黑板只写“左边 -3x -> 右边 +3x”。', '先问：哪一项跨过了等号？跨过去后符号变了吗？', '换成 +5 移到另一边，仍先判断跨等号的项和符号。'],
    ['pressure_unit_rate_compare', /两种包装的牛奶价格和容量不同|哪种更划算|只看总价便宜/, 'math_word_problem', '先统一成每 100 毫升或每 1 毫升多少钱，再比较单位量价格。', '只比较总价，没有把容量差异转成单位量。', '小黑板只画“总价 / 容量 = 单位量价格”。', '先问：两盒容量一样吗？不一样时要比较哪个单位量？', '换成水果单价比较，仍先统一成每千克价格。'],
    ['pressure_similarity_ratio_area', /相似三角形.*边长比是 2:3|面积比也写成 2:3|边长比.*面积比/, 'math_word_problem', '先区分边长比和面积比，面积比要看边长比的平方。', '把长度关系直接套到面积关系，没有识别量的维度变了。', '小黑板只写“边长比 2:3 -> 面积比 4:9”。', '先问：题目问的是长度还是面积？面积是不是二维量？', '换成体积比，仍先判断是一维、二维还是三维量。'],
    ['pressure_narrative_clue_title', /标题“那盏灯”的作用|标题.*作用.*线索|只写标题好看/, 'reading_question', '先判断标题是不是贯穿全文的线索，再看它是否指向人物情感或文章中心。', '只评价标题表面，没有连接线索、人物和中心。', '小黑板只画“标题 -> 线索 -> 中心/情感”。', '先问：文章哪些段落反复出现这个标题里的事物？它和谁的情感有关？', '换成标题“背影”，仍先找反复出现的线索和中心。'],
    ['pressure_argument_evidence_type', /论证方法及作用|只写举例论证|证明了哪个观点/, 'reading_question', '先找这个例子前后服务的分论点，再说论证方法的作用。', '只识别论证方法名称，没有把材料和观点连接起来。', '小黑板只画“论据 -> 证明哪个观点 -> 作用”。', '先问：这个例子是为了证明哪一句观点？', '换成对比论证，仍先找它服务的观点。'],
    ['pressure_composition_detail_scene', /难忘的一次鼓励|只写我很感动|具体动作、语言或神态/, 'writing_process', '先补一个可看见的细节：对方说了哪句话、做了哪个动作或当时的神态。', '只有情绪概括，没有可观察的场景证据。', '小黑板只写“动作 / 语言 / 神态”三格，先填一格。', '先问：那个人当时具体说了哪一句话或做了哪一个动作？', '换成“难忘的一次批评”，仍先补一个可看见的细节。'],
    ['pressure_nonfinite_to_do_purpose', /I went to the library ____ books|borrow 还是 to borrow|表示目的/, 'english_sentence', '先判断空格表示目的，再用 to do 表示“为了做某事”。', '只凭语感选动词形式，没有识别目的关系。', '小黑板只写“目的 -> to do”。', '先问：去图书馆是为了做什么？这个空是不是表示目的？', '换成 went to the park to relax，仍先判断目的关系。'],
    ['pressure_adverbial_clause_unless', /You will miss the bus ____ you hurry up|unless 和 if 混用|unless = if not/, 'english_sentence', '先把 unless 翻成“如果不”，再检查前后句逻辑是否通顺。', '没有先翻译逻辑关系，只按中文“如果”直觉选。', '小黑板只写“unless = if not”。', '先问：这句话是“如果你快点”还是“如果你不快点”？', '换成 unless it rains，仍先翻成 if not 验证逻辑。'],
    ['pressure_cloze_pronoun_reference', /Tom and his sister|随便选 he 或 they|代词.*指代对象/, 'english_sentence', '先回到前一句找代词指代的是一个人还是多个人，再选人称和数。', '只看空格所在句，没有找代词的指代对象。', '小黑板只画“前文对象 -> 单数/复数 -> 代词”。', '先问：这个代词指前文的谁？是一个人还是两个人？', '换成 it/they 指代物品，仍先找前文对象。'],
    ['pressure_physics_pressure_area', /同一块砖平放和竖放|压强一样|受力面积/, 'physics_diagram', '先确认压力相同，再比较受力面积是否变化。', '只看压力，没有把压强和受力面积联系起来。', '小黑板只画“压力相同 / 面积变小 -> 压强变大”。', '先问：这次变的是压力，还是接触面积？', '换成雪地里穿滑雪板，仍先看受力面积变化。'],
    ['pressure_series_parallel_current', /串联和并联电路中电流关系|两个灯泡就默认电流平分|有没有岔路/, 'physics_diagram', '先判断电路是一条路还是有分支，再决定电流处处相等或分流。', '没有先看电流路径，把元件数量当成电流关系依据。', '小黑板只画“一条路 / 分支路”两种电流路径。', '先问：电流从电源出来后有没有岔路？', '换成电压关系，仍先判断串联还是并联。'],
    ['pressure_heat_transfer_direction', /热水和冷水混合|冷水把冷传给热水|热量方向/, 'physics_diagram', '先比较温度高低，再判断热量从高温物体传向低温物体。', '把“冷”当成可以传递的东西，没有用温度差判断热量方向。', '小黑板只画“高温 -> 低温”的热量箭头。', '先问：谁温度更高？热量会从哪边流向哪边？', '换成金属勺放进热汤里，仍先判断高温到低温。'],
    ['pressure_limestone_gas_test', /石灰石和稀盐酸|只写有气泡|检验二氧化碳|澄清石灰水/, 'chemistry_experiment', '先判断气体可能是二氧化碳，再想到通入澄清石灰水观察变浑浊。', '只记录实验现象，没有把气体种类和检验方法对应。', '小黑板只画“气泡 -> CO2? -> 澄清石灰水”。', '先问：这个气体要用什么现象来证明？', '换成燃烧产生气体，仍先找对应检验试剂或现象。'],
    ['pressure_ion_coexistence_precipitate', /Ag\\+ 和 Cl-|离子共存|生成沉淀、气体或水|电荷能抵消/, 'chemistry_experiment', '先检查会不会生成沉淀、气体或水，再判断是否能共存。', '只看电荷，没有检查离子反应条件。', '小黑板只写“沉淀 / 气体 / 水”三项排查。', '先问：这两个离子碰到一起会不会生成难溶物？', '换成 Ba2+ 和 SO4 2-，仍先查是否生成沉淀。'],
    ['pressure_solubility_curve_cooling', /溶解度曲线.*降温|降温后溶解度变小|是否有晶体析出/, 'chemistry_experiment', '先读降温前后的溶解度，再判断是否有晶体析出。', '只看初始溶质量，没有用曲线比较新温度下的最大溶解量。', '小黑板只画“原温度溶解度 -> 新温度溶解度 -> 是否析出”。', '先问：温度变了以后最多还能溶多少？', '换成升温或另一种物质，仍先读曲线前后两个点。'],
    ['pressure_microscope_low_high_power', /从低倍镜换高倍镜|视野变暗|粗准焦螺旋|细准焦/, 'biology_process', '先确认已经换高倍镜，再调亮视野并用细准焦螺旋微调。', '把低倍镜找物像的方法照搬到高倍镜，没有区分粗调和细调。', '小黑板只写“高倍镜 -> 视野暗 -> 调光 / 细准焦”。', '先问：现在是低倍还是高倍？高倍时还能不能大幅转粗准焦？', '换成物像偏到一侧，仍先判断显微镜操作规则。'],
    ['pressure_genetics_dominant_recessive', /父母表现型都正常却生出患病孩子|直接说不可能|表现型和基因型/, 'biology_process', '先判断父母是否可能都是隐性致病基因携带者，再画基因组合。', '只看表现型，没有区分表现型和基因型。', '小黑板只画“表现正常 -> 可能携带 -> 组合”。', '先问：看起来正常是否一定没有致病基因？', '换成显性性状遗传，仍先区分表现型和基因型。'],
    ['pressure_blood_circulation_path', /手臂静脉注射后到达肺部|只背心脏四腔名称|静脉.*右心.*肺/, 'biology_process', '先判断药物进入静脉血回心脏，再按右心房、右心室、肺动脉到肺。', '只背结构名称，没有按血液流动方向排序。', '小黑板只画“静脉 -> 右心 -> 肺”的路径箭头。', '先问：药物进入的是动脉还是静脉？下一站先回到心脏哪一侧？', '换成氧气从肺到全身，仍先按循环路径走。'],
    ['pressure_latitude_temperature_rule', /比较两地气温|不看纬度高低|离赤道更近/, 'geography_map', '先读两地纬度，判断一般纬度越高气温越低。', '按地名印象判断，没有用纬度解释热量差异。', '小黑板只画“低纬 -> 热量多，高纬 -> 热量少”。', '先问：哪个地方离赤道更近？', '换成南北半球城市比较，仍先看纬度和季节。'],
    ['pressure_earth_rotation_time_difference', /北京和伦敦时间不同|只背时差|地球自西向东自转|经度有关/, 'geography_map', '先判断地球自西向东自转，再看两地经度位置导致地方时不同。', '只背城市时差，没有连接自转方向和经度差。', '小黑板只画“自西向东转 -> 东边时间早”。', '先问：地球往哪个方向转？东边和西边谁先看到太阳？', '换成纽约和上海，仍先看经度位置和自转方向。'],
    ['pressure_contour_river_flow', /判断河流流向|按地图上方下方猜|不看海拔数值/, 'geography_map', '先读河流两端海拔数值，再判断水从高处流向低处。', '把图面上下当方向，没有用海拔判断流向。', '小黑板只标“高海拔 -> 低海拔”的箭头。', '先问：哪一端海拔更高？水会往哪边流？', '换成坡度判断，仍先读等高线数值和疏密。'],
    ['pressure_climate_type_homework', /气候类型。孩子只看最高温，不看雨热同期/, 'geography_map', '先读最冷月和最热月气温，再看降水是否集中在夏季。', '只抓一个温度点，没有同时看气温和降水组合。', '小黑板只画“温度范围 + 降水季节 -> 气候类型”。', '先问：冬天冷不冷？雨主要下在夏天还是全年均匀？', '换成地中海气候图，仍先读温度和降水季节。'],
    ['pressure_river_flood_climate', /比较汛期长短|河流长度，不看气候和降水季节分配/, 'geography_map', '先看流域气候和降水季节分配，再判断汛期长短。', '把河流长度当成汛期依据，没有连接气候降水。', '小黑板只画“气候降水 -> 径流变化 -> 汛期”。', '先问：这条河的水主要来自哪里？雨季集中在什么时候？', '换成内流河，仍先判断补给来源和季节变化。'],
    ['pressure_climate_heat_rain_peak', /雨热同期|降水高峰和最高温的峰值月份|最高温.*降水最多月份/, 'geography_map', '先同时看最高温月份和降水最多月份是否接近。', '只看气温，不把降水和气温放在同一时间轴比较。', '小黑板只画“气温高峰 / 降水高峰 / 是否同月附近”。', '先问：最热的时候是不是也最湿？', '换成另一张气候图，仍先找两个峰值月份。'],
    ['pressure_climate_type_distribution', /降水季节分配|判断气候类型.*只看最高温/, 'geography_map', '先判断最冷月/最热月气温，再看降水集中在哪个季节。', '只看温度，不综合气温和降水。', '小黑板只画“气温范围 + 降水季节 -> 气候类型”。', '先问：降水最多在什么季节？', '换一张气候图，仍先读气温和降水两个证据。'],
    ['pressure_sentence_error_exact', /不知道哪里错|只觉得不通顺，不知道主语缺失|由于.*让.*仍先找主语/, 'writing_process', '先找句子主干，发现“通过”和“使”同时出现导致主语缺失。', '没有抓句子主干，只凭读起来顺不顺判断；只润色句子，没有先判断成分残缺和主语缺失。', '小黑板只写“通过...，使...”会让主语消失。', '先问：这句话的主语是谁？删掉“通过”或“使”后主语还在吗？', '换成“由于...，让...”结构或“经过努力，使成绩提高”，仍先找主语。'],
    ['pressure_poetry_imagery_general', /月亮、秋风等意象|景物意象.*情感/, 'reading_question', '先圈诗句里的景物意象，再说它可能承载的情感。', '只翻译字面意思，没有把景物和情感连接起来。', '小黑板只画“景物意象 -> 情感方向”。', '先问：诗里写了哪一个景物？它让人感觉冷、暖、远还是近？', '换一首写月亮的诗，仍先圈意象再说情感。'],
    ['pressure_speed_graph_axis', /哪一段速度大.*线段长短|路程-时间图像，题目问哪一段速度大/, 'physics_diagram', '先确认横轴是时间、纵轴是路程，再比较图线斜率。', '把图线长度当速度，没有用斜率表示快慢。', '小黑板只标横轴、纵轴和两段斜率。', '先问：速度看这段线有多长，还是看它有多陡？', '换成速度-时间图像，仍先分清横纵轴表示什么。'],
    ['pressure_english_reason_evidence_short', /Why did Tom leave early/, 'reading_question', '先判断题目问原因，再回原文找证据句。', '离开原文凭感觉答，没有锁定证据句。', '小黑板只画“题目类型 -> 回文定位 -> 证据句”。', '先问：你的选项旁边能标出原文哪一句吗？', '换一篇更短的段落，仍然先找原因词。'],
    ['pressure_english_reference_sentence', /只看所在句，不回看上一句|名词和事件/, 'reading_question', '先回到 it 前一句，找能被代替的单数名词或整件事。', '只看指代词所在句，没有用前文名词和语义验证；也可能只看本句，没有用上下文寻找指代对象。', '小黑板只画“上一句候选词 -> 代入本句是否通顺”。', '先问：it 前面最近出现的名词是什么？代进去句子通不通？', '换成 they 或 this，仍先找前文指代对象。'],
    ['pressure_chinese_outline_cooperation', /难忘的一次帮助.*结果卡在第一段/, 'writing_process', '先写一句最朴素的开头：那天发生了什么。', '想一次写完全文，导致第一句迟迟落不下来。', '小黑板只画“时间、地点、人物、事件”四格，不评价文采。', '先问：先写一句发生了什么，不用一开始就写得漂亮。', '换成“难忘的一次合作”，仍先写一件事的第一句。'],
    ['pressure_gas_test_exact', /如何检验。孩子只写有气泡/, 'chemistry_experiment', '先列反应前物质，再判断气泡可能对应二氧化碳。', '只记现象，没有把现象和物质变化对应。', '小黑板只画“反应物 -> 气体 -> 澄清石灰水”的三格流程。', '先问：气泡说明产生了什么？你用什么现象证明它？', '换成另一种碳酸盐，仍先说气体和检验。'],
    ['pressure_control_variable_homework_exact', /把温度、水分也写成变量/, 'biology_process', '先说唯一不同的条件是光照。', '没有分清自变量、因变量和控制变量。', '小黑板只画两列并标一个不同点。', '先问：两组除了光照，还有什么应该保持一样？', '把光照换成水分，仍先找唯一一个不同条件。'],
    ['pressure_g7_math_equation_setup', /甲乙两人一共 48 本书，甲比乙多 6 本/, 'equation_setup', '先设乙有 x 本，再把甲写成 x+6。', '没有先设清未知数，急着心算结果。', '在小黑板写“乙=x，甲=x+6，总数=48”。', '你设的 x 代表谁？另一人的数量怎么表示？', '把 48 和 6 换成别的数，先保留同一个等量关系。'],
    ['pressure_g8_physics_lens', /凸透镜两倍焦距以外|先标焦点和两倍焦距/, 'physics_diagram', '先标焦点和两倍焦距，再画一条平行主光轴的光线。', '只背成像规律，没有把位置和光路连起来。', '只画主光轴、焦点和第一条入射光线，不直接给像的位置结论。', '你先标出 F 和 2F，再说物体在哪个区间。', '把物体移到一倍到两倍焦距之间，只重复标点和画第一条线。'],
    ['pressure_g9_chem_gas', /稀盐酸加入碳酸盐固体|碳酸盐和稀盐酸反应产生气体/, 'chemistry_experiment', '先列反应前物质，再判断气泡可能是二氧化碳。', '只记现象，没有把现象和物质变化对应。', '画“反应物 -> 气体 -> 澄清石灰水”的三格流程。', '气泡说明产生了什么？你用什么现象证明它？', '换成另一种碳酸盐，仍先说气体和检验。'],
    ['pressure_g9_chem_solution_color', /酚酞后变红.*红色褪去|紫色石蕊.*酸性还是碱性/, 'chemistry_experiment', '先判断酚酞变红说明溶液显碱性。', '把指示剂颜色当成要背的现象，没有连接酸碱性。', '画“碱性 -> 酚酞红 -> 加酸中和 -> 褪色”的箭头。', '颜色变化对应的是酸碱性变了，还是物质名字变了？', '换成紫色石蕊，先判断颜色对应酸性还是碱性。'],
    ['pressure_g8_english_reading_detail', /志愿活动.*活动发生的原因|Why did Tom leave early/, 'reading_question', '先判断这是原因题，再回原文找 because、so、to help 这类证据句。', '离开原文凭感觉答，没有锁定证据句。', '只画“题目问原因 -> 回文定位 -> 证据句”三步。', '你选项旁边能标出原文哪一句吗？', '换一篇更短的段落，仍然先找原因词。'],
    ['pressure_g7_bio_photosynthesis', /光合作用需要什么条件和产生什么物质|换成呼吸作用，仍然先分四栏/, 'biology_process', '先把条件、场所、原料、产物分成四栏。', '把过程口诀背散了，结构和功能没有连起来。', '画“光、叶绿体、二氧化碳和水 -> 有机物和氧气”的空格图。', '你先说这是条件、原料、场所还是产物？', '换成呼吸作用，仍然先分四栏。'],
    ['pressure_control_variable', /一组有光一组遮光|一组有光一组无光|对照实验变量/, 'biology_process', '先说唯一不同的条件是光照。', '没有分清自变量、因变量和控制变量。', '画两列：有光、无光，只标一个不同点。', '两组除了光照，还有什么应该保持一样？', '把光照换成水分，仍先找唯一一个不同条件。'],
    ['pressure_g6_chinese_writing', /写一件让我难忘的小事|难忘的一次帮助.*完整作文/, 'writing_process', '先写一句最朴素的开头：那天发生了什么。', '想一次写完全文，导致第一句迟迟落不下来。', '只画“时间地点人物事件”四格，不评价文采。', '先写一句发生了什么，不用一开始就写得漂亮。', '换成“难忘的一次帮助”，仍先写一件事的第一句。'],
    ['pressure_g6_chinese_outline_homework_deep', /难忘的一次帮助.*第一段/, 'writing_process', '先写一句最朴素的开头：那天发生了什么。', '想一次写完全文，导致第一句迟迟落不下来。', '小黑板只画“时间、地点、人物、事件”四格，不评价文采。', '先问：先写一句发生了什么，不用一开始就写得漂亮。', '换成“难忘的一次合作”，仍先写一件事的第一句。'],
    ['pressure_speed_graph_homework', /路程[-－]?时间图像.*终点路程.*斜率|哪一段速度大.*线段长短/, 'physics_diagram', '先判断速度看路程随时间变化的斜率。', '把终点路程当速度，没有看单位时间变化量。', '小黑板只画“时间增加 1 份，路程增加几份”。', '先问：速度看终点数值，还是看每单位时间走多少？', '换一条更陡的直线，仍先比较单位时间路程。'],
    ['pressure_ph_curve', /向酸中逐滴加入碱.*pH 曲线逐渐升高/, 'chemistry_experiment', '先看图像起点 pH 小于 7，说明一开始是酸性。', '只背中和反应，没有用图像起点和变化方向判断过程。', '小黑板只标“起点 <7 / 逐渐升高 / 经过 7”。', '先问：曲线一开始在 7 的上面还是下面？', '换成向碱中加酸，仍先看起点和变化方向。'],
    ['pressure_poem_moon_hometown', /明月、故乡|明月.*故乡|月亮、秋风|诗句里有明月、故乡/, 'reading_question', '先圈出明月、故乡这两个意象，再判断它们常指向思乡情感。', '只逐字翻译，没有把意象和情感联系起来。', '小黑板只写“意象 -> 常见情感 -> 诗句证据”。', '先问：诗里哪个物象最能提示情感？', '换成柳、送别诗句，仍先圈意象再说情感。'],
    ['pressure_english_behavior_inference', /没有直接写人物生气.*关上门不说话|行为证据.*推情绪/, 'reading_question', '先找行为证据，再判断这些行为暗示的情绪。', '把推断题当成原文原句题，没有用行为证据推情绪。', '小黑板只写“行为证据 -> 可能情绪”。', '先问：哪一个动作能支持你的推断？', '换成角色低头沉默，仍先找行为证据再推情绪。'],
    ['pressure_english_infer_evidence', /What can we infer from the passage|熟悉的句子，没有找文本证据/, 'reading_question', '先回到原文定位相关句，再判断哪一项是合理推断而不是原文照抄。', '把熟悉词当答案，没有区分原文信息和推断。', '小黑板只画“原文证据 -> 合理推出 -> 选项”。', '先问：原文哪一句支持这个推断？', '换成 best title，仍先定位核心证据。'],
    ['pressure_blood_route', /体循环路径.*左心室、右心房|体循环从左心室出发/, 'biology_process', '先判断体循环从左心室出发，最后回到右心房。', '把肺循环和体循环的起点终点混淆。', '小黑板只画“左心室 -> 全身 -> 右心房”。', '先问：这题问体循环还是肺循环？起点是哪一个心腔？', '换成肺循环，仍先说起点和终点。'],
    ['pressure_monsoon_water_vapor', /夏季风从海洋吹向陆地.*带来降水/, 'geography_map', '先判断夏季风从海洋来，带来水汽。', '只背风向，没有连接水汽来源和降水。', '小黑板只画“海洋 -> 陆地 -> 水汽 -> 降水”。', '先问：这股风从哪里来？有没有带来水汽？', '换成冬季风，仍先判断来自海洋还是陆地。'],
    ['pressure_paragraph_center', /合作经历.*没有中心句|段落重点不清/, 'writing_process', '先写这一段的中心句，只说这一段围绕哪一个意思。', '没有先定段落中心，想到哪里写到哪里，容易跑题。', '小黑板只画“中心句 -> 一个例子 -> 一句感受”。', '先问：这一段只想说明哪一个意思？', '换成写一次比赛，仍先写中心句再补例子。'],
    ['pressure_action_detail_scene', /只写“他帮了我”|没有动作、语言和画面/, 'writing_process', '先补一个动作细节，不急着把整段重写。', '只写概括句，没有用动作、语言或神态把画面落下来。', '小黑板只列“动作 / 语言 / 神态”三格，先填一格。', '先问：这一句能不能加一个看得见的动作？', '换成老师鼓励我，仍只补一个动作或一句语言。'],
    ['pressure_lever_pivot', /撬棍题.*省力还是费力|先标支点和力臂/, 'physics_diagram', '先标支点，再分别找动力臂和阻力臂。', '把力的大小和力臂混在一起，没有先确定支点。', '小黑板只画“支点 O -> 动力臂 / 阻力臂”两条线。', '先问：支点在哪里？力臂是到力的作用线的距离，还是杆的长度？', '换成剪刀或跷跷板，仍先标支点和两个力臂。'],
    ['pressure_lever_arm_homework', /支点、动力和阻力都给出|不会画力臂/, 'physics_diagram', '先找到支点，再画力的作用线和支点到作用线的垂直距离。', '把力到支点的斜距离当成力臂，没有画垂直距离。', '小黑板只画“支点 -> 作用线 -> 垂直力臂”。', '先问：力臂是到力的作用点，还是到作用线的垂直距离？', '换成剪刀或撬棒，仍先画支点和垂直力臂。'],
    ['pressure_probability_tree', /连续摸两次不放回.*两次颜色不同|两步树状图/, 'math_word_problem', '先列出第一次摸球后的剩余总数，再分情况写第二次可能结果。', '把不放回当成每次总数不变，没有分步更新样本空间。', '小黑板只画“两步树状图：第一次 -> 第二次剩余”。', '先问：第一次摸完以后，袋子里总数有没有变？', '换成抽卡不放回，仍先画两步树状图。'],
    ['pressure_parallel_angle', /两条平行线被截线所截.*角度|看到数字就直接相加/, 'math_word_problem', '先标出同位角、内错角或同旁内角关系，再决定能不能列式。', '没有先识别平行线角关系，直接用看到的数字凑结果。', '小黑板只圈一对角，并标“同位/内错/同旁”。', '先问：这两个角是什么关系？平行线给了哪条规则？', '换一张角的位置图，仍先说角关系再算。'],
    ['pressure_english_reference_it', /it 指代什么|只看 it 所在句/, 'reading_question', '先回到 it 前一句，找能被代替的单数名词或整件事。', '只看指代词所在句，没有用前文名词和语义验证。', '小黑板只画“前文名词/事件 -> it”。', '先问：it 前面最近出现的名词是什么？代进去句子通不通？', '换成 they 或 this，仍先找前文指代对象。'],
    ['pressure_photo_respiration_split', /白天和夜晚植物气体变化|光合和呼吸的方向混了/, 'biology_process', '先判断有没有光，再分别看光合作用和呼吸作用是否同时进行。', '把光合作用和呼吸作用当成同一个过程，没有区分条件和气体方向。', '小黑板只画“有光/无光 -> 光合/呼吸 -> 气体方向”。', '先问：现在有没有光？呼吸作用是不是一直存在？', '换成夜晚植物实验，仍先判断光照条件。'],
    ['pressure_climate_graph', /气温曲线和降水柱状图.*只看最高温|雨热同期/, 'geography_map', '先读最冷月和最热月气温，再看降水是否集中在夏季。', '只抓一个温度点，没有同时看气温和降水组合。', '小黑板只画“温度范围 + 降水季节 -> 气候类型”。', '先问：冬天冷不冷？雨主要下在夏天还是全年均匀？', '换成地中海气候图，仍先读温度和降水季节。'],
    ['pressure_sentence_revision_subject', /通过这次活动，使我明白了合作的重要|经过努力，使成绩提高/, 'writing_process', '先找句子缺不缺主语，再删去“通过”或“使”中的一个。', '只润色句子，没有先判断成分残缺。', '小黑板只画“通过/使 -> 主语被遮住”。', '先问：这句话是谁明白了合作的重要？', '换成“经过努力，使成绩提高”，仍先找主语。'],
    ['pressure_sentence_error_subject', /句子“通过这次活动，使我明白了合作的重要。”/, 'writing_process', '先找句子主干，发现“通过”和“使”同时出现导致主语缺失。', '没有抓句子主干，只凭读起来顺不顺判断。', '小黑板只写“通过...，使...”会让主语消失。', '先问：这句话的主语是谁？删掉“通过”或“使”后主语还在吗？', '换成“由于...，让...”结构，仍先找主语。'],
    ['pressure_earth_shadow_sun_angle', /正午影子冬天更长|太阳高度角|日地距离/, 'geography_map', '先判断季节对应的正午太阳高度，再由太阳高度解释影子长短。', '把影子长短归因于日地距离，没有用太阳高度角解释。', '小黑板只画“太阳高度高/低 -> 影子短/长”。', '先问：冬天正午太阳高度更高还是更低？影子会怎么变？', '换成夏至和冬至晷长比较，仍先看太阳直射位置。'],
    ['pressure_linear_function_intercept', /与 y 轴交点在 3|x=0 时的值|水箱初始水量图/, 'math_word_problem', '先找到图像与 y 轴的交点，判断 x=0 时的值。', '只看上升下降，没有把 y 轴交点和初始量对应起来。', '小黑板只画 y 轴交点并标“x=0”。', '先问：图像一开始从 y 轴哪个数出发？', '换成水箱初始水量图，仍先找 x=0 的截距。'],
    ['pressure_purification_sequence', /粗盐提纯.*溶解、过滤、蒸发|含沙食盐水/, 'chemistry_experiment', '先判断粗盐要先溶解，把可溶物进水，再过滤不溶物，最后蒸发得到晶体。', '把实验步骤当名称背诵，没有按分离目的排序。', '小黑板只画“溶解 -> 过滤 -> 蒸发”的三格流程。', '先问：哪一步让盐进水？哪一步留下泥沙？哪一步把水赶走？', '换成含沙食盐水，仍先按溶解、过滤、蒸发说目的。']
  ];
  const exactHomeworkCases = [
    ...
    ['speed_graph_slope', /哪一段速度大|只看线段长短|路程[-－]?时间图像.*终点路程.*斜率|路程时间图像.*终点路程.*斜率/, 'physics_diagram', '先判断速度看路程随时间变化的斜率。', '把终点路程当速度，没有看单位时间变化量。', '小黑板只标横轴时间、纵轴路程和两段斜率。', '先问：速度看终点多远，还是看同样时间内路程变化多快？', '换成速度-时间图像，仍先分清横纵轴表示什么。'],
  ...
  exactHomeworkCases.push(
    ...
    ,
    ['inequality_word_boundary', /还要留 8 元坐车|不超过 38|最多能买几本|5x\+8/, 'equation_setup', '先设最多买 x 本，再写 5x+8 不超过 38。', '没有把“还要留 8 元”和“不超过”翻译成不等式关系。', '小黑板只写“5x + 8 <= 38”，先不解 x。', '先问：8 元是也要花进去，还是剩下来不能动？', '换成买练习册并留 10 元，仍先写不超过关系。'],
    ['linear_function_intercept', /与 y 轴交点在 3|只看斜率，不知道截距表示什么|x=0 时的值/, 'math_word_problem', '先找到图像与 y 轴的交点，判断 x=0 时的值。', '只看上升下降，没有把 y 轴交点和初始量对应起来。', '小黑板只画 y 轴交点并标“x=0”。', '先问：图像一开始从 y 轴哪个数出发？', '换成水箱初始水量图，仍先找 x=0 的截距。'],
    ['probability_without_replacement', /先摸出 1 个红球不放回|仍用 3\/5|不放回.*红球/, 'math_word_problem', '先判断不放回后红球和总球数都变了，再重新数红球 2 个、总数 4 个。', '把第一次摸球后的样本空间变化忽略了。', '小黑板只画“原来 3/5 -> 摸走红球 -> 2/4”。', '先问：第一次摸走后，盒子里还剩几个红球、几个球？', '换成摸走白球，仍先更新总数和有利结果。'],
    ['lever_arm_perpendicular', /力臂当成杆的长度|从支点.*垂线|力的作用线|杠杆/, 'physics_diagram', '先找支点，再从支点向力的作用线作垂线确定力臂。', '把力臂误认为杆长，没有抓住到力的作用线的垂直距离。', '小黑板只画支点、力的作用线和一条垂直力臂。', '先问：力臂是到力的作用点，还是到力的作用线的垂直距离？', '换成斜向拉力，仍先延长作用线再作垂线。'],
    ['percent_two_step_base_change', /先降价\s*20%.*再降\s*10%|两个百分数直接相加成降价\s*30%|降价后的价格上再降/, 'math_word_problem', '先判断第二次降价的基准已经变成第一次降价后的价格。', '把两个百分数当作同一个单位量上的变化，忽略了第二次的基准变化。', '小黑板只画“原价 -> 降 20% 后的价 -> 再降 10%”。', '先问：第二个 10% 是按原价算，还是按降价后的价格算？', '换成先涨价再打折，仍先找每一次变化的基准。'],
    ['parallel_angle_relation', /两条平行线被截线所截.*角度|看到数字就直接相加.*平行线|平行线.*同位角|平行线.*内错角|平行线.*同旁内角/, 'math_word_problem', '先标出同位角、内错角或同旁内角关系，再决定能不能列式。', '没有先识别平行线角关系，直接用看到的数字凑结果。', '小黑板只画两条平行线、一条截线和对应角位置。', '先问：这两个角是同位角、内错角，还是同旁内角？', '换成三角形外角题，仍先标角的位置关系。'],
    ['heat_efficiency_input_output', /热机效率|燃料放出热量和水吸收热量|效率怎么算|(?:燃料|热量|水吸收|有用热量|总放热).*直接相加/, 'physics_diagram', '先区分有用热量和燃料总放热，再写效率是有用热量除以总放热。', '没有分清输入总能量和被利用的有用能量。', '小黑板只画“燃料总放热 -> 水吸收的有用热量 -> 效率”。', '先问：哪一个是总投入，哪一个是真正被水吸收利用？', '换成电热水壶效率，仍先分总输入和有用输出。'],
    ['ph_mixing_direction', /向酸中逐滴加入碱|pH 图像|起点和方向|曲线经过 7/, 'chemistry_experiment', '先看 pH 起点小于 7，判断原溶液是酸，再看曲线向上说明加入碱。', '只记中和经过 7，没有用起点和变化方向判断实验过程。', '小黑板只标“起点<7 -> 酸；曲线上升 -> 加碱”。', '先问：曲线一开始在 7 上面还是下面？后来往哪个方向走？', '换成向碱中加酸，仍先看起点和方向。'],
    ['purification_sequence', /粗盐提纯.*溶解、过滤、蒸发三个步骤混在一起|不知道先后顺序和每步目的/, 'chemistry_experiment', '先判断粗盐要先溶解，把可溶物进水，再过滤不溶物，最后蒸发得到晶体。', '把实验步骤当名称背诵，没有按分离目的排序。', '小黑板只画“溶解 -> 过滤 -> 蒸发”的三格流程。', '先问：哪一步让盐进水？哪一步留下泥沙？哪一步把水赶走？', '换成含沙食盐水，仍先按溶解、过滤、蒸发说目的。'],
    ['passive_voice_agent', /The window.*by Tom yesterday|看到 Tom 就想填主动|过去时被动|was done/, 'english_sentence', '先找 by Tom 和 yesterday，再判断主语 window 是承受动作，用过去时被动。', '只看动作执行者，没有判断主语是动作承受者。', '小黑板只写“承受者 window + by + 过去时间 -> was done”。', '先问：窗户是做动作的人，还是被做动作的对象？', '换成 The room was cleaned，仍先找承受者和时间。'],
    ['preposition_time_range', /in the morning|on Monday|at 7 o’clock|介词.*凭感觉/, 'english_sentence', '先判断后面是大时间段、具体某一天还是具体时刻。', '没有按时间范围区分 in、on、at。', '小黑板只画“大时间段 in / 具体天 on / 具体时刻 at”。', '先问：这个时间是一天里的范围，还是某一天，还是一个钟点？', '换成地点介词，仍先判断范围、表面或点位。'],
    ['english_inference_not_detail', /What can we infer|直接抄原文一句细节|推断题/, 'reading_question', '先判断这是推断题，再找两处细节合起来推出结论。', '把推断题当细节题，只复制原文表层信息。', '小黑板只画“细节1 + 细节2 -> 推断”。', '先问：这句话原文直接说了吗？还是要由两处信息推出来？', '换成作者意图题，仍先区分原文细节和推断结论。'],
    ['classical_function_word', /“之”在两个句子里意思不同|都按“的”翻译|文言虚词|句中功能/, 'reading_question', '先把“之”放回句子，看它是代词、助词还是动词。', '把文言虚词固定翻译成一个现代意思，没有看句中功能。', '小黑板只写“原句 -> 之的位置 -> 句中功能”。', '先问：这个“之”在句子里代替谁，还是只起连接作用？', '换成“其”“而”，仍先放回句子看功能。'],
    ['poem_image_emotion', /落花.*意象|表达什么情感.*只翻译字面意思|题目问表达的情感.*只翻译字面意思.*意象/, 'reading_question', '先圈意象“落花”，再联系诗句氛围判断情感。', '只做字面翻译，没有把意象和情感连接。', '小黑板只画“意象 -> 氛围 -> 情感”。', '先问：这个景物让人感觉明快、伤感还是孤独？', '换成“孤雁”“明月”，仍先说意象和情感方向。'],
    ['composition_material_select_center', /一个帮助我的人|列了三件事但每件都很散|不知道选哪件/, 'writing_process', '先确定中心是“这个人怎样帮助我”，再选最能证明中心的一件事。', '把材料数量当丰富，没有让材料服务同一个中心。', '小黑板只画“中心句 -> 最能证明的一件事 -> 一个细节”。', '先问：哪一件事最能说明他怎么帮助你？', '换成“难忘的一课”，仍先定中心再选一件事。'],
    ['sentence_coherence_order', /几句话顺序混乱|时间和逻辑顺序|总起句|语段修改/, 'writing_process', '先找总起句，再按时间、空间或因果顺序排列。', '凭语感排序，没有抓总分结构和逻辑线索。', '小黑板只写“总起 -> 线索 -> 细节句”。', '先问：哪一句像开头总说？后面按什么顺序展开？', '换成说明文语段，仍先找总起句和顺序词。'],
    ['hormone_blood_sugar_direction', /饭后血糖升高.*胰岛素变化|只背激素名字.*变量方向/, 'biology_process', '先判断血糖升高，再说胰岛素分泌增加帮助降低血糖。', '只背激素名称，没有连接血糖变化方向和调节结果。', '小黑板只画“血糖升高 -> 胰岛素增加 -> 血糖下降”。', '先问：身体要把血糖往上调还是往下调？', '换成运动后血糖降低，仍先判断变量方向和调节目标。'],
    ['respiration_photosynthesis_split', /植物夜晚也进行呼吸作用|晚上不消耗氧气|光合作用和呼吸作用/, 'biology_process', '先区分光合作用和呼吸作用，再判断呼吸作用全天进行。', '把光合作用和呼吸作用混为一谈，没有区分条件和产物。', '小黑板只画“光合作用需光；呼吸作用全天”。', '先问：这个过程需不需要光？白天晚上是否都发生？', '换成萌发种子实验，仍先判断是否在进行呼吸作用。'],
    ['agriculture_location_conditions', /适合种水稻还是小麦|不看气候和水源/, 'geography_map', '先看气温、降水和水源条件，再判断适合的农业类型。', '只看区域名称，没有用自然条件解释农业选择。', '小黑板只画“热量 + 降水 + 水源 -> 作物”。', '先问：这种作物更需要热、水，还是耐旱耐寒？', '换成畜牧业区位，仍先看气候、水源和地形。'],
    ['industry_location_conditions', /钢铁厂布局|只看城市大小|原料、能源和交通/, 'geography_map', '先列原料、能源、交通和市场四个区位条件。', '把城市规模当唯一依据，没有分析工业区位条件。', '小黑板只画“原料/能源/交通/市场”四格。', '先问：这个工厂最需要靠近原料、能源、交通还是市场？', '换成电子工业，仍先列主导区位条件。']
  );
  ...
  const exactHomeworkCase = priorityHomeworkCases.concat(exactHomeworkCases, pressureHomeworkCases).find((item) => item[1].test(source));
