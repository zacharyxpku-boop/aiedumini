...
function detectTaskType(text = '', selected = {}) {
  ...
  if (/相似三角形|对应边|比例顺序|不对应边/.test(source)) {
...
function inferHomeworkPressureSignal(text = '', taskType = 'unknown') {
  ...
  exactHomeworkCases.push(
    ['linear_function_intercept', /y=2x\+3|截距|起始量/, 'math_word_problem', '先看图像是否过原点，再分别解释斜率和截距表示什么。', '把一次函数和正比例混在一起，只看斜率没有看截距。', '小黑板只画“斜率=每次变化量，截距=起始量”。', '先问：这条线过原点吗？如果不过，起始量是什么？', '换成 y=3x-2，仍先分斜率和截距。'],
    ['similar_triangle_ratio_order', /相似三角形|对应边|比例顺序|把不对应边相乘/, 'math_word_problem', '先在两个三角形中标出对应角，再按对应边顺序写比例。', '没有先找对应关系，直接把看起来相近的边相乘。', '小黑板只画“对应角 -> 对应边 -> 比例式”。', '先问：哪两个角相等？它们夹着的边分别对应谁？', '换成平行线分线段题，仍先找对应边。'],
    ['electric_power_nameplate', /电功率|额定电压|额定功率|实际功率|灯泡铭牌/, 'physics_diagram', '先分清额定值和实际值，再判断当前电压是否等于额定电压。', '把额定功率当成任何情况下的实际功率。', '小黑板只写“额定条件 / 实际条件”两栏。', '先问：现在给的电压是额定电压，还是实际电压？', '换成实际电压变小，仍先分额定和实际。'],
    ['buoyancy_state_force_balance', /漂浮|悬浮|下沉|浮沉条件/, 'physics_diagram', '先判断物体状态是漂浮、悬浮还是下沉，再比较浮力和重力。', '只背密度大小，没有先用受力平衡判断浮沉状态。', '小黑板只画“漂浮/悬浮/下沉 -> 浮力与重力关系”。', '先问：它现在是静止漂浮，还是正在下沉？浮力和重力谁大？', '换成悬浮小球，仍先判断状态和受力关系。'],
    ['acid_base_salt_reaction_order', /酸碱盐|复分解|沉淀气体水|离子能否结合/, 'chemistry_experiment', '先判断离子交换后是否生成沉淀、气体或水。', '只背反应表，没有先看产物是否满足复分解条件。', '小黑板只画“交换离子 -> 查沉淀/气体/水”。', '先问：交换后有没有沉淀、气体或水出现？', '换成硫酸钠和氯化钡，仍先看是否生成沉淀。'],
    ['lab_operation_filter_evaporate', /过滤|蒸发|玻璃棒|漏斗|液体飞溅|实验操作错误/, 'chemistry_experiment', '先判断这一步是过滤还是蒸发，再说玻璃棒的作用。', '把实验步骤混在一起，没有根据操作目的判断仪器作用。', '小黑板只画“过滤:引流；蒸发:搅拌防飞溅”。', '先问：这一步是在分离固液，还是在蒸干溶液？', '换成粗盐提纯，仍先分过滤和蒸发。'],
    ['cloze_context_emotion', /上下文情绪|情绪发生变化|前后文情绪|转折和因果提示/, 'english_sentence', '先读空格前后两句，判断情绪或逻辑关系，再选词。', '只看空格所在句，没有用上下文情绪和逻辑关系。', '小黑板只画“前句情绪 -> 后句动作 -> 逻辑词”。', '先问：前后两句是顺接、转折还是因果？情绪有没有变？', '换成原因结果句，仍先判断上下文关系。'],
    ['reading_author_attitude', /作者态度|褒贬|评价色彩|态度题/, 'reading_question', '先圈出带评价色彩的词，再判断作者态度是赞同、反对还是客观。', '只凭自己感觉判断态度，没有找评价词证据。', '小黑板只写“评价词 -> 态度 -> 证据句”。', '先问：哪一个词能看出作者是赞成还是反对？', '换成说明文观点题，仍先找评价或判断词。'],
    ['genetic_probability_punnett', /遗传概率|显性隐性|Aa|杂合|后代比例/, 'biology_process', '先写出亲代基因型，再画简单组合格看后代类型。', '只背三比一，没有先写亲代基因型和配子组合。', '小黑板只画“A/a 配子 -> 四格组合”。', '先问：父母各能产生哪几种配子？', '换成 Aa 和 aa，仍先写配子再组合。'],
    ['ecosystem_energy_flow', /逐级递减|消费者数量多|数量多等同于能量多/, 'biology_process', '先写出食物链顺序，再判断能量从生产者逐级传递并递减。', '把数量多等同于能量多，没有按食物链方向判断。', '小黑板只画“生产者 -> 初级消费者 -> 次级消费者”。', '先问：能量最先从谁进入这条食物链？', '换成另一条食物链，仍先找生产者。'],
    ['terrain_profile_contour', /地形剖面|坡陡坡缓|等高线疏密|穿过的等高线/, 'geography_map', '先看等高线疏密判断坡度，再按穿过的等高线高度画剖面。', '只看山峰高低，没有用等高线疏密和穿线顺序。', '小黑板只画“等高线疏密 -> 坡度；穿线高度 -> 剖面”。', '先问：这里等高线密还是疏？路线穿过哪些高度？', '换成另一条剖面线，仍先按穿线高度读。'],
    ['plate_boundary_earthquake', /板块交界|地震火山|环太平洋|挤压张裂/, 'geography_map', '先判断位置是否在板块交界处，再看是挤压还是张裂边界。', '把地震火山当成随机分布，没有联系板块边界。', '小黑板只画“板块边界 -> 挤压/张裂 -> 地震火山”。', '先问：这个区域在板块内部还是交界处？', '换成地中海喜马拉雅带，仍先找板块交界。']
    ,
    ['function_trend_reading', /一次函数图像经过两个点|函数增减性|从左到右|上升还是下降/, 'math_word_problem', '先看图像从左到右是上升还是下降。', '只想套公式，没有先读图像趋势。', '只画坐标轴和一条从左到右的趋势箭头。', '从左往右看，这条线是往上还是往下？', '换一条下降直线，仍先判断趋势再说增减性。'],
    ['buoyancy_direction_basic', /浮力方向|大小关系|物体浸在水中|重力和浮力混在一起/, 'physics_diagram', '先标浮力方向竖直向上，再和重力方向区分。', '把浮力方向和重力方向混淆。', '只画物体、向下重力箭头和向上浮力箭头。', '浮力是水托物体，方向先往哪边？', '换成物体下沉情境，仍先标浮力方向。'],
    ['food_chain_arrow_direction', /食物链|能量流动方向|箭头方向画反|草、兔、鹰|谁吃谁的方向/, 'biology_process', '先从被吃的生物指向吃它的生物。', '把捕食关系和能量流动箭头方向混淆。', '只画“草 -> 兔 -> 鹰”的一条箭头链。', '箭头表示能量流向谁，不是表示谁去抓谁。', '换成草、昆虫、青蛙，仍先从生产者画起。'],
    ['contour_ridge_valley_shape', /等高线题|山脊还是山谷|山脊和山谷|弯曲方向|只看海拔数值/, 'geography_map', '先看等高线弯曲方向，再判断山脊或山谷。', '只看海拔数值，没有看等高线形态。', '只画一组弯曲等高线和水流/高低方向箭头。', '等高线往高处凸还是往低处凸？', '换一张等高线图，仍先判断弯曲方向。'],
    ['argument_evidence_claim', /议论文.*事例证明|作者用哪个事例证明观点|没有回到文章论点|论点和论据/, 'reading_question', '先找到文章中心论点，再圈支撑它的事例论据。', '把个人观点当答案，没有区分论点和论据。', '小黑板只画“论点 -> 事例论据 -> 证明关系”。', '这句话是作者观点，还是用来证明观点的例子？', '换一段议论文，仍先圈论点和事例。'],
    ['cloze_context_nearby', /完形填空.*天气很冷|穿上外套|只看空格所在一句|只看空格前后两个词/, 'reading_question', '先读空格前后两句，找语境线索。', '只看空格所在一句，没有利用上下文。', '小黑板只画“前句线索 -> 空格 -> 后句验证”。', '空格前一句给了什么线索？选项能不能被后一句验证？', '换一个完形空，仍先读前后两句。'],
    ['river_flow_elevation', /河流流向|等高线和河流|地图上下方向|高处流向低处/, 'geography_map', '先看地势高低，河流从高处流向低处。', '把地图上下当成实际流向，没有看海拔变化。', '小黑板只画“高海拔 -> 低海拔”的箭头。', '河流看地图上方下方，还是看海拔高低？', '换一张等高线河流图，仍先找高处和低处。']
  );
  const priorityHomeworkCases = [
    ['contour_shape_homework_board', /题目问山脊还是山谷|只看海拔数字，没有看等高线弯曲方向/, 'geography_map', '先看等高线弯曲方向，再判断山脊或山谷。', '只看海拔数值，没有看等高线形态。', '小黑板只画一组弯曲等高线和水流/高低方向箭头。', '先问：等高线往高处凸还是往低处凸？', '换一张等高线图，仍先判断弯曲方向。'],
    ['food_chain_three_node_arrow_exact', /草、兔、鹰之间画箭头|草、兔、鹰.*谁吃谁的方向/, 'biology_process', '先从被吃的生物指向吃它的生物。', '把捕食关系和能量流动箭头方向混淆。', '小黑板只画“草 -> 兔 -> 鹰”的一条箭头链。', '先问：箭头表示能量流向谁，不是表示谁去抓谁。', '换成草、昆虫、青蛙，仍先从生产者画起。'],
    ['food_chain_four_node_energy_exact', /草、兔、狐、鹰排序|草、兔、狐、鹰.*不理解能量流动方向/, 'biology_process', '先判断箭头表示能量流动方向，从被吃者指向捕食者。', '把箭头当成捕食动作方向，没理解能量流动。', '小黑板只画“草 -> 兔 -> 狐 -> 鹰”的能量箭头。', '先问：箭头表示谁把能量传给谁？', '换成水草、小鱼、大鱼，仍先判断能量从谁开始。'],
    ['buoyancy_density_volume_exact', /分别浸在水和盐水中|液体密度和排开液体体积/, 'physics_diagram', '先圈液体密度和排开液体体积这两个量。', '只看物体本身，忽略浮力和液体密度、排开体积有关。', '小黑板只画“液体密度 × 排开体积”两个格子。', '先问：这次变化的是液体，还是物体体积？', '换成同一液体里排开体积不同，仍先圈两个决定量。'],
    ['cloze_semantic_context_exact', /天气很冷，后文说穿上外套|不用上下文语义线索/, 'reading_question', '先读空格前后两句，找情绪转折或结果线索。', '只看空格附近词，没有用上下文验证语义。', '小黑板只画“前句线索 -> 空格 -> 后句验证”。', '先问：下一句支持这个词，还是推翻这个词？', '换成名词或动词完形，仍先看前后句线索。'],
    ['cloze_happy_cry_context_exact', /happy.*he started to cry|只看空格前后两个词/, 'english_sentence', '先读空格前后两句，找情绪转折或结果线索。', '只看空格附近词，没有用上下文验证语义。', '小黑板只画“前句线索 -> 空格 -> 后句验证”。', '先问：下一句支持这个词，还是推翻这个词？', '换成名词或动词完形，仍先看前后句线索。'],
    ['cloze_cold_coat_nearby_exact', /空格前一句说天气很冷，后一句说他穿上外套|随便选词/, 'reading_question', '先读空格前后两句，找语境线索。', '只看空格所在一句，没有利用上下文。', '小黑板只画“前句线索 -> 空格 -> 后句验证”。', '先问：空格前一句给了什么线索？选项能不能被后一句验证？', '换一个完形空，仍先读前后两句。'],
    ['cloze_cold_coat_context', /天气很冷.*穿上外套.*只看空格所在句/, 'english_sentence', '先读空格前后两句，找冷、外套这类语义线索。', '只看单句语法，没有用上下文证据判断词义。', '小黑板只写“前句线索 -> 空格 -> 后句验证”。', '先问：这个选项能不能被前后两句同时支持？', '换成表示转折的 but 句子，仍先看前后逻辑。'],
    ['food_chain_four_node_energy', /草、兔、狐、鹰.*箭头方向按谁吃谁/, 'biology_process', '先判断箭头表示能量流动方向，从被吃者指向捕食者。', '把箭头当成捕食动作方向，没理解能量流动。', '小黑板只画“草 -> 兔 -> 狐 -> 鹰”的能量箭头。', '先问：箭头表示谁把能量传给谁？', '换成水草、小鱼、大鱼，仍先判断能量从谁开始。'],
    ['contour_slope_river_elevation', /等高线密集处.*坡度和河流流向|只看上下位置，不看海拔数字/, 'geography_map', '先读等高线数值，再判断高处到低处和密集程度。', '按图面上下判断方向，没有看海拔和等高线疏密。', '小黑板只标“高 -> 低”和“密集 -> 坡陡”。', '先问：哪边海拔更高？等高线哪里更密？', '换成山谷山脊判断，仍先读海拔数字。'],
    ['electric_power_unit_energy_split', /额定电压和电流.*千瓦时|分不清功率和电能/, 'physics_diagram', '先圈电压、电流和单位，再判断用 P=UI 还是电能关系。', '只套公式，没有先统一单位和区分功率、电能。', '小黑板只写“P=UI / 单位先统一”。', '先问：题目问功率还是电能？单位有没有从千瓦时换清楚？', '换一个用电器参数，仍先圈电压、电流和单位。'],
    ['filter_impurity_soluble_check', /泥沙混在水里.*滤液滤渣|把所有分离都说成过滤/, 'chemistry_experiment', '先判断要分离的是不溶性固体和液体。', '把过滤当成万能分离方法，没有先看杂质是否溶于水。', '小黑板只画“浑浊液 -> 滤纸 -> 滤液/滤渣”。', '先问：这个杂质是溶在水里，还是不溶在水里？', '换成食盐水和泥沙，仍先判断能不能过滤。'],
    ['buoyancy_float_sink_density', /不同液体中漂浮或下沉|只看物体大小/, 'physics_diagram', '先判断物体状态是漂浮、悬浮还是下沉，再比较浮力和重力。', '只看物体体积，忽略受力状态和液体密度。', '小黑板只画“浮力 F浮”和“重力 G”的上下箭头。', '先问：物体现在是漂浮还是下沉？F浮 和 G 谁大？', '换成盐水和清水，仍先判断状态再比较力。'],
    ['ecosystem_three_node_energy', /草、兔、狐组成食物链.*能量流动方向|箭头画成谁吃谁/, 'biology_process', '先确定生产者，再按能量从被吃者流向捕食者画箭头。', '把箭头理解成捕食动作，没有理解能量流动方向。', '小黑板只画“草 -> 兔 -> 狐”的能量方向。', '先问：能量最开始从哪个生物进入这条链？', '换成食物网，仍先找生产者和能量方向。'],
    ['contour_valley_ridge_shape_detail', /判断山谷和山脊.*只看线密不密/, 'geography_map', '先看等高线弯曲方向，再判断凸向高处是山谷、凸向低处是山脊。', '只看坡陡坡缓，没有判断地形部位。', '小黑板只画“等高线弯曲方向 -> 高/低处 -> 山谷/山脊”。', '先问：等高线是向高处弯，还是向低处弯？', '换成鞍部或陡崖，仍先看等高线形态。'],
    ['electric_power_energy_time', /220V 40W.*2 小时|正常工作.*消耗多少电能/, 'physics_diagram', '先判断正常工作时直接用额定功率和时间求电能。', '把电压当成唯一决定量，忽略功率和时间。', '小黑板只画“功率 P -> 时间 t -> 电能 W”。', '先问：这题问电能，已知的是功率还是电压？', '换成 60W 灯泡 30 分钟，仍先找 P 和 t。'],
    ['filter_operation_detail', /泥水分离时玻璃棒、滤纸和漏斗口的位置|不知道操作错误在哪里/, 'chemistry_experiment', '先判断过滤要分离不溶性固体和液体，再检查一贴二低三靠。', '只记实验名称，没有把操作细节和分离目的对应。', '小黑板只画“混合物 -> 滤纸 -> 滤液/残渣”。', '先问：这一步要让谁留下、谁通过？', '换成粗盐提纯，仍先判断过滤分离的是哪两部分。'],
    ['cloze_cold_coat_nearby', /空格前一句说天气很冷.*后一句说他穿上外套|随便选词/, 'reading_question', '先读空格前后两句，找语境线索。', '只看空格所在一句，没有利用上下文。', '小黑板只画“前句线索 -> 空格 -> 后句验证”。', '先问：空格前一句给了什么线索？选项能不能被后一句验证？', '换一个完形空，仍先读前后两句。']
  ];
  const exactHomeworkCase = priorityHomeworkCases.concat(exactHomeworkCases).find((item) => item[1].test(source));
