...
function inferHomeworkPressureSignal(text = '', taskType = 'unknown') {
  ...
  const exactHomeworkCase = pressureHomeworkCases.concat(priorityHomeworkCases, exactHomeworkCases).find((item) => item[1].test(source));
